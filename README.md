...
│   └── (additional files based on template type)
├── public/                 # Static assets
├── package.json            # Dependencies and scripts
└── README.md              # This file
```

**Template-specific organization:**
- **SPA**: All components in single `App.tsx` file - perfect for demos and prototypes
- **Multi**: Organized `/pages` directory with separate page files - ideal for production apps
- **FBCA**: Feature-based `/features` directory structure - advanced scalable architecture
...
### Theme Configuration
Switch themes by updating the ThemeProvider in `src/App.tsx`:
...
Styles are configured in `src/index.css` with modern Tailwind v4+ syntax:
...
- **[Tailwind CSS v4+](https://tailwindcss.com)** - Utility-first CSS framework framework
...
VITE_APP_TITLE=multiapp
```

### UIKit CLI Commands
If you have the UIKit CLI installed globally, you can use additional commands:

```bash
uikit serve           # Enhanced dev server with theme bundling
uikit build           # Production build with SEO generation
uikit bundle          # Standalone theme bundling
uikit generate        # Code generation utilities
```

### Code Quality
This project includes TypeScript for static type checking. Additional linting and formatting tools may be configured based on your template choice.
