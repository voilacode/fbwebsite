const fresherbotTheme = {
  ...
  light: {
    ...
    secondary: '#6366F1',            // Vibrant purple for gradients
    secondaryForeground: '#FFFFFF',

    // Supporting colors
    muted: '#F3F4F6',
    mutedForeground: '#6B7280',
    accent: '#F59E0B',               // Orange for better gradients
  ...
  dark: {
    ...
    primary: '#3B82F6',
    primaryForeground: '#FFFFFF',
    secondary: '#8B5CF6',            // Vibrant purple for gradients
    secondaryForeground: '#FFFFFF',

    muted: '#1F2937',
    mutedForeground: '#9CA3AF',
    accent: '#F59E0B',               // Orange for gradients
    accentForeground: '#FFFFFF',
