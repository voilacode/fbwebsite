...
const navigationItems: NavigationItem[] = [
  ...
  { 
    ...
    items: [
      ...
      { key: 'tms', label: 'TMS Platform', href: '/products/tms', icon: Users },
    ]
  },
  { 
    key: 'services', 
    ...
    icon: Package,
    items: [
      { key: 'crt', label: 'Campus Recruitment Training', href: '/services/crt', icon: Brain },
      { key: 'drives', label: 'Campus Drives', href: '/services/drives', icon: GraduationCap },
      { key: 'projects', label: 'Academic Projects', href: '/services/projects', icon: Users },
    ]
  },
  {
  key: 'events',
...
const Logo: React.FC = () => (
  <div className="flex items-center gap-3">
    ...
    <div>
      <h3 className="voila-brand-logo text-xl font-bold">Fresherbot</h3>
      <p className="text-xs text-background">VoilaCode Technologies</p>
    </div>
  </div>
);
